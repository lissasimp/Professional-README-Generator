//function to display license badges
...
//function to display license guidelines
...
## License
Terms and conditions for use, reproduction, and distribution can be found here: ${renderLicense(
    data.license
  )} 
